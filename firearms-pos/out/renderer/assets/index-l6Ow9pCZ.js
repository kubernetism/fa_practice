import { t as useBranch, v as useCurrency, Z as useCurrentBranchSettings, r as reactExports, j as jsxRuntimeExports, y as Tabs, z as TabsList, A as TabsTrigger, P as Package, W as Wrench, _ as TabsContent, I as Input, C as Card, e as CardContent, $ as ScrollArea, a0 as Plus, a1 as Badge, a2 as Clock, b as CardHeader, c as CardTitle, B as Button, U as User, X, a3 as CircleAlert, a4 as Trash2, J as Percent, a5 as Separator, p as Banknote, a6 as CreditCard, a7 as Dialog, a8 as DialogContent, a9 as DialogHeader, aa as DialogTitle, ab as DialogDescription, ac as UserPlus, L as Label, ad as DialogFooter, ae as Ticket, af as Phone, o as Receipt, T as Truck, D as DollarSign, ag as Building2, K as Select, M as SelectTrigger, O as SelectValue, Q as SelectContent, V as SelectItem } from "./index-C_D_4RtI.js";
import { C as Checkbox } from "./checkbox-vWZ0Ipq_.js";
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent } from "./tooltip-Dr3Oo0zx.js";
import { S as Search } from "./search-BsWtoAus.js";
import { M as Minus } from "./minus-DOxs3Ia4.js";
import { S as Smartphone } from "./smartphone-BxTtKoUS.js";
...
Card: **** **** **** ${cardLastFourDigits}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-[calc(100vh-8rem)] gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showPaymentDialog, onOpenChange: setShowPaymentDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md p-0 gap-0 border-border/50 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-5 py-4 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold font-mono tabular-nums", children: formatCurrency(total) })
        ] })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-4 max-h-[60vh] overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border p-3 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Ticket, { className: "h-4 w-4 text-amber-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "voucher-code", className: "font-medium text-amber-800 dark:text-amber-300", children: "Voucher Code" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border p-3 bg-green-50 dark:bg-green-950/20 dark:border-green-800/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Percent, { className: "h-4 w-4 text-green-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "discount", className: "font-medium text-green-800 dark:text-green-300", children: "Apply Discount" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showSuccessDialog, onOpenChange: setShowSuccessDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-[420px] p-0 gap-0 border-border/50 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "sr-only", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Sale Complete" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Invoice details" })
      ] }),
      completedSale && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-500 px-6 py-5 text-white text-center relative overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-10", style: {
            backgroundImage: "radial-gradient(circle at 20% 50%, white 1px, transparent 1px), radial-gradient(circle at 80% 50%, white 1px, transparent 1px)",
            backgroundSize: "30px 30px"
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-8 w-8 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold tracking-wide", children: "Sale Complete!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-emerald-100 text-xs mt-1", children: "Transaction processed successfully" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-3 bg-muted/30 border-b border-border/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-semibold uppercase tracking-widest text-muted-foreground/60", children: "Invoice" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-sm font-bold tracking-wider", children: [
              "#",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate max-w-[180px]", children: completedSale.customerName })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-b-2 border-t-2 border-foreground/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold uppercase tracking-wider", children: "Total Amount" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold font-mono tabular-nums", children: formatCurrency(completedSale.totalAmount) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium capitalize", children: completedSale.paymentMethod === "receivable" ? "Pay Later" : completedSale.paymentMethod })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-semibold text-xs uppercase tracking-wider px-2 py-0.5 rounded-full ${completedSale.paymentStatus === "paid" ? "bg-emerald-500/10 text-emerald-500" : completedSale.paymentStatus === "partial" ? "bg-amber-500/10 text-amber-500" : "bg-slate-500/10 text-slate-400"}`, children: completedSale.paymentStatus })
            ] }),
            completedSale.amountPaid > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Amount Paid" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono tabular-nums font-medium text-emerald-500", children: formatCurrency(completedSale.amountPaid) })
            ] }),
            completedSale.changeGiven > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Change Returned" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono tabular-nums font-medium", children: formatCurrency(completedSale.changeGiven) })
            ] }),
            completedSale.remainingAmount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-sm rounded-lg bg-amber-500/10 border border-amber-500/20 px-3 py-2 mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-500 font-medium", children: "Added to Receivables" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono tabular-nums font-bold text-amber-500", children: formatCurrency(completedSale.remainingAmount) })
            ] })
          ] }),
          completedSale.newCustomerCreated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs bg-blue-500/10 border border-blue-500/20 rounded-lg px-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "h-3.5 w-3.5 text-blue-500" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-blue-500", children: [
              "New customer ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: completedSale.codName }),
              " created from COD details"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-5 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            size: "lg",
