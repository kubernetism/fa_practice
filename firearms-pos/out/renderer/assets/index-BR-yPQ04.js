import { c as createLucideIcon, A as React, j as jsxRuntimeExports, V as useBranch, d as useAuth, r as reactExports, s as RefreshCw, Z as TooltipProvider, B as Button, a as LoaderCircle, w as Check, a5 as Tooltip, a6 as TooltipTrigger, a7 as TooltipContent, ak as Plus, _ as Tabs, $ as TabsList, a0 as TabsTrigger, aj as TabsContent, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, ad as Badge, a1 as DollarSign, al as Trash2, a3 as Card, aV as CardHeader, aW as CardTitle, ae as FileText, bd as CardDescription, a4 as CardContent, ah as CreditCard, a$ as CircleCheckBig, b0 as CircleX, J as Receipt, be as Wallet, I as Input, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, L as Label, q as Textarea, am as DialogFooter } from "./index-B52pgjeh.js";
...
import { P as Pencil } from "./pencil-CP-1plvR.js";
...
import { f as format, a as CircleArrowDown, C as CircleArrowUp } from "./format-DMW74jko.js";
/**
...
function ChartOfAccountsScreen() {
  ...
  const [openingDate, setOpeningDate] = reactExports.useState(format(/* @__PURE__ */ new Date(), "yyyy-MM-dd"));
  const [openingOffsetId, setOpeningOffsetId] = reactExports.useState("");
  const [openingNotes, setOpeningNotes] = reactExports.useState("");
  const [openingSubmitting, setOpeningSubmitting] = reactExports.useState(false);
...
${details}`);
  ...
  const equityAccounts = reactExports.useMemo(
  ...
  const openOpeningDialog = (account) => {
    setSelectedAccount(account);
    setOpeningAmount("");
    setOpeningDate(format(/* @__PURE__ */ new Date(), "yyyy-MM-dd"));
    const defaultOffset = equityAccounts.find((a) => a.accountCode === "3000") || equityAccounts.find((a) => a.accountCode === "3100") || equityAccounts[0];
  ...
  const handleSetOpeningBalance = async () => {
    ...
    try {
      const result = await window.api.chartOfAccounts.setOpeningBalance({
        ...
        notes: openingNotes.trim() || void 0
      });
      if (result.success) {
        alert(
...
Journal: ${result.data.journalEntry}`
      ...
      alert("Failed to post opening balance: " + e.message);
    } finally {
...
Journal entry: ${result.data.journalEntry}`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(PiggyBank, { className: "h-3.5 w-3.5" })
                    }
                  ) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: "Set Opening Balance" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: openingDialog, onOpenChange: setOpeningDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { onOpenAutoFocus: (e) => e.preventDefault(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Set Opening Balance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: selectedAccount && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          "Post an opening balance for ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
            selectedAccount.accountCode,
            " — ",
            selectedAccount.accountName
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Opening Amount *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Equity Offset Account *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: openingOffsetId, onValueChange: setOpeningOffsetId, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select equity account" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: equityAccounts.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: String(a.id), children: [
                a.accountCode,
                " — ",
                a.accountName
              ] }, a.id)) })
        ...
        selectedAccount && openingAmount && !isNaN(parseFloat(openingAmount)) && parseFloat(openingAmount) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg text-sm bg-blue-500/10 text-blue-400 space-y-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: "Journal preview" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSetOpeningBalance, disabled: openingSubmitting, children: openingSubmitting ? "Posting…" : "Post Opening Balance" })
      ] })
    ] }) }),
