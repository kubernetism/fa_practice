import { V as useBranch, Y as useCurrency, r as reactExports, j as jsxRuntimeExports, b8 as BadgePercent, Z as TooltipProvider, B as Button, ak as Plus, a3 as Card, a4 as CardContent, a1 as DollarSign, af as Clock, D as Users, I as Input, X, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, J as Receipt, ad as Badge, a5 as Tooltip, a6 as TooltipTrigger, a7 as TooltipContent, R as RotateCcw, al as Trash2, C as ChevronRight, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, _ as Tabs, $ as TabsList, a0 as TabsTrigger, v as UserPlus, aj as TabsContent, L as Label, q as Textarea, am as DialogFooter } from "./index-B52pgjeh.js";
...
import { B as Ban } from "./ban-BvMsSnNU.js";
...
import "./triangle-alert-Bp7w_-Fu.js";
...
function CommissionsScreen() {
  ...
  const handleInvoiceChange = async (saleId) => {
  ...
  const handleRateModeChange = (mode) => {
    setFormData((prev) => {
      ...
      if (mode === "flat") {
        const rate2 = parseFloat(prev.rate) || 0;
        const flat2 = base > 0 && rate2 > 0 ? (base * rate2 / 100).toFixed(2) : prev.flatAmount;
        return { ...prev, rateMode: mode, flatAmount: flat2 };
      }
  ...
  const handleFlatAmountChange = (flatAmount) => {
    setFormData((prev) => {
      const base = parseFloat(prev.baseAmount) || 0;
  ...
  const handleBaseAmountChange = (baseAmount) => {
    setFormData((prev) => {
      const base = parseFloat(baseAmount) || 0;
      if (prev.rateMode === "flat") {
        const flat2 = parseFloat(prev.flatAmount) || 0;
        const rate = base > 0 && flat2 > 0 ? (flat2 / base * 100).toFixed(4) : "";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            ...
            formData.saleId && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "baseAmount-referral", children: "Base Amount (profit) *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Auto-filled with profit from this sale. Edit if a different base is needed." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "rate-referral", children: formData.rateMode === "percent" ? "Commission Rate (%) *" : "Commission Amount *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex rounded-md border border-border overflow-hidden", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        className: `px-2 py-0.5 text-[10px] font-medium ${formData.rateMode === "percent" ? "bg-primary text-primary-foreground" : "bg-background text-muted-foreground hover:bg-muted"}`,
                        children: "%"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        className: `px-2 py-0.5 text-[10px] font-medium ${formData.rateMode === "flat" ? "bg-primary text-primary-foreground" : "bg-background text-muted-foreground hover:bg-muted"}`,
                        children: "Flat"
                      }
                    )
                  ] })
                ] }),
                formData.rateMode === "percent" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "rate-referral",
                    type: "number",
                ...
                formData.referralPersonId && (() => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: formData.rateMode === "percent" ? `Default for this person: ${defaultRate}%` : `Derived from ${formData.rate || "—"}% (default ${defaultRate}%)` });
                })()
              ] })
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "employee", className: "space-y-4 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Enter the sale/invoice ID — base amount will auto-fill with profit." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "baseAmount-employee", children: "Base Amount (profit) *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "rate-employee", children: formData.rateMode === "percent" ? "Commission Rate (%) *" : "Commission Amount *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex rounded-md border border-border overflow-hidden", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
