import { c as createLucideIcon, x as commonjsGlobal, y as getDefaultExportFromCjs, r as reactExports, z as clsx, A as React, u as useNavigate, D as Users, P as Package, F as Settings, G as Truck, W as Wrench, H as ShoppingCart, J as Receipt, O as Banknote, j as jsxRuntimeExports, f as Crosshair, B as Button, X, Q as ScrollArea, C as ChevronRight, V as useBranch, Y as useCurrency, Z as TooltipProvider, a as LoaderCircle, w as Check, _ as Tabs, $ as TabsList, a0 as TabsTrigger, a1 as DollarSign, a2 as formatNumber, a3 as Card, a4 as CardContent, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, a5 as Tooltip$1, a6 as TooltipTrigger, a7 as TooltipContent } from "./index-B52pgjeh.js";
import { t as toPng, C as Camera } from "./index-DlnzQL8h.js";
import { B as Building } from "./building-CJFU_dIh.js";
import { U as UserCheck } from "./user-check-Dz7kd3u1.js";
import { C as CircleCheck } from "./circle-check-BOgu7Fvm.js";
...
import { C as ChartColumn } from "./chart-column-BqhUOFLH.js";
/**
...
function SetupChecklist() {
  ...
  const handleSkip = reactExports.useCallback(async (key) => {
    const result = await window.api.setup.updateChecklistItem(key, "skipped");
    if (result.success && result.data) {
      setChecklist(result.data);
    }
  }, []);
  const handleDismiss = reactExports.useCallback(async () => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(217,170,75,0.015) 2px, rgba(217,170,75,0.015) 4px)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center justify-between px-4 py-2.5 border-b border-amber-900/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-7 w-7 items-center justify-center rounded-md bg-amber-500/10 border border-amber-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Crosshair, { className: "h-3.5 w-3.5 text-amber-500" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold tracking-tight text-foreground", children: "Setup Operations" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-amber-500/70 font-medium tracking-wide uppercase", children: allDone ? "All objectives complete" : `${completedCount} of ${CHECKLIST_ITEMS.length} objectives` })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-28 h-1.5 rounded-full bg-muted/50 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "h-full rounded-full transition-all duration-700 ease-out",
                  style: {
                    width: `${progressPercentage}%`,
                    background: allDone ? "linear-gradient(90deg, #22c55e, #16a34a)" : "linear-gradient(90deg, #d4a44b, #b8860b)"
                  }
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono text-muted-foreground tabular-nums", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-border/30 p-px", children: CHECKLIST_ITEMS.map((item, index) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `group relative flex items-center gap-2.5 px-3 py-2.5 transition-colors duration-150 ${isCompleted ? "bg-card/80" : "bg-card hover:bg-amber-500/[0.04]"}`,
              style: {
              ...
              children: [
                isCompleted ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheck,
                  {
                    className: `h-4 w-4 shrink-0 ${isSkipped ? "text-muted-foreground/50" : "text-green-500"}`
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-4 w-4 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border border-amber-500/30" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-[3px] rounded-full bg-amber-500/20" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Icon,
                  {
                    className: `h-3.5 w-3.5 shrink-0 ${isCompleted ? "text-muted-foreground/40" : "text-amber-500/60"}`
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `text-xs font-medium leading-tight truncate ${isCompleted ? "text-muted-foreground/50 line-through decoration-muted-foreground/30" : "text-foreground"}`,
                      children: item.title
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground/60 truncate leading-tight mt-0.5", children: item.description })
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center justify-between px-4 py-2 border-t border-amber-900/20 bg-card/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground/50", children: allDone ? "All set — you can dismiss this panel" : "Skip items you don't need right now" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
              ...
              children: allDone ? "Dismiss" : "I'm Done Setting Up"
            }
          )
        ] })
      ]
...
const ReportCard = React.forwardRef(
  ({ businessName, branchName, periodLabel, generatedAt, formatCurrency, formatNumber: formatNumber2, stats, fundFlow }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, style: s2.root, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.header, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.bizName, children: businessName || "POS System" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.metaRow, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.metaText, children: branchName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: s2.periodBadge, children: periodLabel })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.heroRow, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.heroCell, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.heroLabel, children: "Revenue" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.heroValue, color: "#38bdf8" }, children: formatCurrency(stats.grossRevenue) }),
          (stats.returnDeductions > 0 || stats.totalDiscount > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: s2.heroSub, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.heroCell, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.heroLabel, children: "Profit" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.heroValue, color: profitColor }, children: formatCurrency(profit) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.heroSub, children: "After costs & deductions" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.heroCell, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.heroLabel, children: "Cash In Hand" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.heroValue, color: "#34d399" }, children: formatCurrency(stats.cashInHand) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.heroSub, children: "Register balance" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.section, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.sectionTitle, children: "Sales & Cost" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.grid2, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Sales" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: s2.rowValue, children: [
              formatNumber2(stats.totalSalesCount),
              " txns"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Units Sold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatNumber2(stats.totalProductsSold) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Total Cost" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatCurrency(stats.totalCost) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Returns" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: stats.totalReturns > 0 ? "#fb923c" : "#e2e8f0" }, children: formatCurrency(stats.totalReturns) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Purchases" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatCurrency(stats.totalPurchases) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Expenses" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatCurrency(stats.totalExpense) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.section, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.sectionTitle, children: "Deductions & Receivables" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.grid2, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Discounts" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: stats.totalDiscount > 0 ? "#f472b6" : "#e2e8f0" }, children: formatCurrency(stats.totalDiscount) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Tax Collected" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatCurrency(stats.totalTaxCollected) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Commission" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatCurrency(stats.totalCommission) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...s2.divider } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "AR Pending" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: stats.receivablesPending > 0 ? "#facc15" : "#e2e8f0" }, children: formatCurrency(stats.receivablesPending) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "AR Received" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: "#34d399" }, children: formatCurrency(stats.receivablesReceived) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "AP Pending" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: stats.payablesPending > 0 ? "#f87171" : "#e2e8f0" }, children: formatCurrency(stats.payablesPending) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "AP Paid" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: "#34d399" }, children: formatCurrency(stats.payablesPaid) })
          ] })
        ] })
      ] }),
      fundFlow && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.section, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.sectionTitle, children: "Fund Flow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Opening Cash" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatCurrency(fundFlow.openingCash) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "+ Sales (Cash)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: "#34d399" }, children: formatCurrency(fundFlow.cashFromSales) })
        ] }),
        fundFlow.arCollections > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "+ AR Collections" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: "#34d399" }, children: formatCurrency(fundFlow.arCollections) })
        ] }),
        fundFlow.deposits > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "+ Deposits" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: "#34d399" }, children: formatCurrency(fundFlow.deposits) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: "1px solid rgba(148,163,184,0.12)", margin: "4px 0" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowLabel, fontWeight: 600, color: "#38bdf8" }, children: "Total Available" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: "#38bdf8" }, children: formatCurrency(fundFlow.openingCash + fundFlow.totalCashIn) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: "1px solid rgba(148,163,184,0.12)", margin: "4px 0" } }),
        fundFlow.apPayments > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "- AP Payments" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { ...s2.rowValue, color: "#f87171" }, children: [
            "(",
            formatCurrency(fundFlow.apPayments),
            ")"
          ] })
        ] }),
        fundFlow.expensesPaid > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "- Expenses" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { ...s2.rowValue, color: "#f87171" }, children: [
            "(",
            formatCurrency(fundFlow.expensesPaid),
            ")"
          ] })
        ] }),
        fundFlow.refunds > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "- Refunds" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { ...s2.rowValue, color: "#fb923c" }, children: [
            "(",
            formatCurrency(fundFlow.refunds),
            ")"
          ] })
        ] }),
        fundFlow.withdrawals > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "- Withdrawals" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { ...s2.rowValue, color: "#f87171" }, children: [
            "(",
            formatCurrency(fundFlow.withdrawals),
            ")"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: "1px solid rgba(148,163,184,0.12)", margin: "4px 0" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowLabel, fontWeight: 700, color: "#34d399" }, children: "Closing Cash" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: "#34d399", fontSize: 14 }, children: formatCurrency(fundFlow.closingCash) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...s2.section, borderBottom: "none" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.sectionTitle, children: "Inventory" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.grid2, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Active Products" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowValue, children: formatNumber2(stats.totalProducts) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.row, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.rowLabel, children: "Low Stock Alerts" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...s2.rowValue, color: stats.lowStockCount > 0 ? "#f87171" : "#34d399" }, children: formatNumber2(stats.lowStockCount) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.footer, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s2.footerMain, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.footerDate, children: generatedAt }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.footerBrand, children: businessName || "POS System" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: s2.devInfo, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: s2.devText, children: "Developed by Syed Safdar Ali Shah · programmersafdar@live.com · 0316-0917600" }) })
      ] })
    ] });
  }
);
...
function KpiCell({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `h-3 w-3 shrink-0 ${iconColor}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold uppercase tracking-wider text-muted-foreground truncate", children: label })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-lg font-bold tabular-nums leading-tight ${valueColor || ""}`, children: value }),
    sub && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-orange-500 leading-tight mt-0.5 truncate", children: sub }),
    allTimeValue && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[9px] text-muted-foreground mt-0.5 tabular-nums", children: [
      allTimeLabel,
      ": ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground/70", children: allTimeValue })
    ] })
  ] }) });
}
function MetricRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 py-[3px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[11px] truncate ${bold ? "font-semibold text-foreground" : "text-muted-foreground"}`, children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[11px] tabular-nums shrink-0 ${bold ? "font-bold" : "font-semibold"} ${valueColor || ""}`, children: value })
  ] });
}
function SectionLabel({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[9px] font-bold uppercase tracking-widest text-muted-foreground/70 mb-1 mt-2 first:mt-0", children });
}
function StockBar({ current, min: min2 }) {
  const pct = min2 > 0 ? Math.min(current / min2 * 100, 100) : 0;
  const critical = pct <= 30;
  const warn3 = pct <= 60 && !critical;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 w-full rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `h-full rounded-full transition-all ${critical ? "bg-red-500" : warn3 ? "bg-amber-500" : "bg-emerald-500"}`,
      style: { width: `${pct}%` }
    }
  ) });
}
function DashboardScreen() {
  ...
  const [allTimeStats, setAllTimeStats] = reactExports.useState(null);
  const [lowStockItems, setLowStockItems] = reactExports.useState([]);
  const [trendChart, setTrendChart] = reactExports.useState(null);
  const [fundFlow, setFundFlow] = reactExports.useState(null);
  const [chartFilter, setChartFilter] = reactExports.useState("revenue_profit");
  const [timePeriod, setTimePeriod] = reactExports.useState("daily");
  const [customDate, setCustomDate] = reactExports.useState(() => (/* @__PURE__ */ new Date()).toISOString().split("T")[0]);
  ...
  const handleCopyDashboard = reactExports.useCallback(async () => {
  ...
  const fetchDashboardData = reactExports.useCallback(async (silent = false) => {
    if (!currentBranch) return;
    if (!silent) setIsLoading(true);
    try {
      const dateParams = timePeriod === "custom" ? { customStart: customDate, customEnd: customDate } : {};
      const [statsResult, allTimeResult, lowStockResult, trendResult, fundFlowResult] = await Promise.all([
        window.api.dashboard.getStats({ branchId: currentBranch.id, timePeriod, ...dateParams }),
        window.api.dashboard.getStats({ branchId: currentBranch.id, timePeriod: "all-time" }),
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "theme-agentfactory flex h-full items-center justify-center bg-background text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-4 border-primary border-t-transparent" }) });
  }
  const profit = stats?.totalProfit || 0;
  const profitPositive = profit >= 0;
  const hasDeductions = (stats?.returnDeductions || 0) > 0 || (stats?.totalDiscount || 0) > 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { delayDuration: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "theme-agentfactory flex h-full flex-col gap-1.5 overflow-hidden bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-bold leading-tight truncate min-w-0", children: currentBranch?.name || "Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs, { value: timePeriod, onValueChange: (v2) => setTimePeriod(v2), children: /* @__PURE__ */ jsxRuntimeExports.jsx(TabsList, { className: "h-6", children: Object.keys(TIME_PERIOD_LABELS).map((period) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: period, className: "text-[10px] px-2 h-4", children: [
          period === "custom" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "h-2.5 w-2.5 mr-0.5" }) : null,
          TIME_PERIOD_LABELS[period]
        ] }, period)) }) }),
        timePeriod === "custom" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "date",
            value: customDate,
            onChange: (e3) => setCustomDate(e3.target.value),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-6 gap-1.5 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        KpiCell,
        {
          icon: DollarSign,
          ...
          allTimeValue: allTimeStats ? formatCurrency(allTimeStats.grossRevenue) : void 0,
          valueColor: "text-blue-600",
          sub: hasDeductions ? `Net: ${formatCurrency(stats?.totalRevenue || 0)}` : void 0
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        KpiCell,
        {
          ...
          allTimeValue: allTimeStats ? formatCurrency(allTimeStats.totalProfit) : void 0,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        KpiCell,
        {
          ...
          allTimeValue: allTimeStats ? formatNumber(allTimeStats.totalSalesCount) : void 0,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-1.5 flex-1 min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-3 min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-2.5 h-full overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Cost & Outflows" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "Total Cost (COGS)", value: formatCurrency(stats?.totalCost || 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "Purchases", value: formatCurrency(stats?.totalPurchases || 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "Expenses", value: formatCurrency(stats?.totalExpense || 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          MetricRow,
          {
            label: "Returns",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Deductions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          MetricRow,
          {
            label: "Discounts",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "Tax Collected", value: formatCurrency(stats?.totalTaxCollected || 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "Commission (Paid)", value: formatCurrency(stats?.totalCommission || 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Accounts Receivable" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          MetricRow,
          {
            label: "Pending",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Accounts Payable" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          MetricRow,
          {
            label: "Pending",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-2 min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-2.5 h-full overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Fund Flow" }),
        fundFlow ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "Opening Cash", value: formatCurrency(fundFlow.openingCash) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-1 border-t border-border/40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "+ Sales (Cash)", value: formatCurrency(fundFlow.cashFromSales), valueColor: "text-green-600" }),
          fundFlow.arCollections > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "+ AR Collections", value: formatCurrency(fundFlow.arCollections), valueColor: "text-green-600" }),
          fundFlow.deposits > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "+ Deposits", value: formatCurrency(fundFlow.deposits), valueColor: "text-green-600" }),
          fundFlow.pettyCashIn > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "+ Petty Cash In", value: formatCurrency(fundFlow.pettyCashIn), valueColor: "text-green-600" }),
          fundFlow.cashIn > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "+ Cash In", value: formatCurrency(fundFlow.cashIn), valueColor: "text-green-600" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-1 border-t border-border/40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            MetricRow,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-1 border-t border-border/40" }),
          fundFlow.apPayments > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "- AP Payments", value: `(${formatCurrency(fundFlow.apPayments)})`, valueColor: "text-red-500" }),
          fundFlow.expensesPaid > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "- Expenses", value: `(${formatCurrency(fundFlow.expensesPaid)})`, valueColor: "text-red-500" }),
          fundFlow.refunds > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "- Refunds", value: `(${formatCurrency(fundFlow.refunds)})`, valueColor: "text-orange-500" }),
          fundFlow.withdrawals > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "- Withdrawals", value: `(${formatCurrency(fundFlow.withdrawals)})`, valueColor: "text-red-500" }),
          fundFlow.pettyCashOut > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricRow, { label: "- Petty Cash Out", value: `(${formatCurrency(fundFlow.pettyCashOut)})`, valueColor: "text-red-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-1 border-t border-border/40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            MetricRow,
            {
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "No cash session data" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-4 min-h-0 flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-2.5 flex flex-col flex-1 min-h-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-[9px] font-bold uppercase tracking-widest text-muted-foreground/70 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-2.5 w-2.5 text-blue-500" }),
            "Business Progress"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            trendChart && trendChart.points.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] bg-blue-500/10 text-blue-500 px-1.5 py-0.5 rounded-full font-medium", children: trendChart.badge }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: chartFilter, onValueChange: (v2) => setChartFilter(v2), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-5 w-[120px] text-[9px] px-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.keys(CHART_FILTER_LABELS).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: key, className: "text-xs", children: CHART_FILTER_LABELS[key] }, key)) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0", children: !trendChart || trendChart.points.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "No data for this period" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: trendChart.points, margin: { top: 5, right: 5, left: -15, bottom: 0 }, barCategoryGap: "20%", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "hsl(var(--border))", opacity: 0.3 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            XAxis,
            {
              dataKey: "label",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            YAxis,
            {
              ...
              tickLine: false,
              tickFormatter: (v2) => {
                if (v2 >= 1e6) return `${(v2 / 1e6).toFixed(1)}M`;
                if (v2 >= 1e3) return `${(v2 / 1e3).toFixed(0)}K`;
                return v2.toString();
              }
            }
          ),
          ...
          trendChart.series.map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Bar,
            {
              dataKey: key,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-3 min-h-0 flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-2.5 flex flex-col flex-1 min-h-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-[9px] font-bold uppercase tracking-widest text-muted-foreground/70 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PackageX, { className: "h-2.5 w-2.5 text-red-500" }),
            "Low Stock Items"
          ] }),
          lowStockItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] bg-red-500/10 text-red-500 px-1.5 py-0.5 rounded-full font-medium", children: [
            lowStockItems.length,
            " items"
          ] })
        ] }),
        lowStockItems.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "h-6 w-6 text-emerald-500/40 mx-auto mb-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "All stock levels OK" })
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 pr-2", children: lowStockItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip$1, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-medium truncate cursor-default", children: item.productName }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipContent, { side: "left", className: "text-xs", children: [
                item.productName,
                " (",
                item.productCode,
                ")"
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-[10px] font-bold tabular-nums shrink-0 ${item.quantity <= 0 ? "text-red-500" : item.quantity <= item.minQuantity * 0.3 ? "text-red-500" : "text-amber-500"}`, children: [
              item.quantity,
              "/",
              item.minQuantity
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StockBar, { current: item.quantity, min: item.minQuantity })
        ] }, item.productId)) }) })
      ] }) })
    ] }),
