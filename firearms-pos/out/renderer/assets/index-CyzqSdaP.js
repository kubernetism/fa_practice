import { c as createLucideIcon, j as jsxRuntimeExports, E as Building2, as as Sparkles, a1 as Shield, at as useSetup, r as reactExports, L as Label, I as Input, v as Select, w as SelectTrigger, x as SelectValue, y as SelectContent, z as SelectItem, O as Textarea, B as Button, H as DollarSign, n as Clock, m as CreditCard, P as Package, u as useNavigate, F as ChevronRight, au as Check } from "./index-DnIY7vW3.js";
import { C as Card, d as CardContent } from "./card-D1PjFjWG.js";
import { M as MapPin } from "./map-pin-CyOW34Nv.js";
import { R as RefreshCw } from "./refresh-cw-DQ0wp5bp.js";
import { C as Copy } from "./copy-Dioxc3ac.js";
import { C as ChevronLeft } from "./chevron-left-BjZ1TARE.js";
import { L as LoaderCircle } from "./loader-circle-xwOrK6oT.js";
/**
...
function BusinessInfoStep() {
  ...
  const businessNameRef = reactExports.useRef(null);
  const renderCount = reactExports.useRef(0);
  renderCount.current += 1;
  reactExports.useEffect(() => {
    log$2(`Component rendered - count: ${renderCount.current}`);
  });
  reactExports.useEffect(() => {
    log$2(`BusinessInfo in step:`, {
  ...
  reactExports.useEffect(() => {
    log$2("Setting up auto-focus timer");
    const timer = setTimeout(() => {
      log$2("Auto-focus executing");
      businessNameRef.current?.focus();
    }, 100);
    return () => {
      log$2("Cleaning up auto-focus timer");
      clearTimeout(timer);
    };
  }, []);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            ...
            onChange: (e) => {
              log$2("Business name onChange:", e.target.value.substring(0, 20));
...
function BranchSetupStep() {
  ...
  const branchNameRef = reactExports.useRef(null);
  const renderCount = reactExports.useRef(0);
  renderCount.current += 1;
  reactExports.useEffect(() => {
    if (renderCount.current % 10 === 1) {
      log$1(`Rendered - count: ${renderCount.current}`);
    }
  });
  reactExports.useEffect(() => {
    if (renderCount.current > 50) {
  ...
  reactExports.useEffect(() => {
    if (hasAutoFilledGlobal) {
      log$1("Auto-fill already done globally, skipping");
      return;
    }
    if (!branchInfo.name && businessInfo.businessName) {
      log$1("Auto-filling branch info from business info (first time)");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Main Branch Setup" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Configure your primary store location" })
      ] })
    ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              onChange: (e) => {
                log$1("Branch name onChange:", e.target.value.substring(0, 20));
...
function TaxCurrencyStep() {
  ...
  const taxNameRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const timer = setTimeout(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "w-5 h-5 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Tax & Currency Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Configure financial settings" })
      ] })
    ] }),
...
function OperationsStep() {
  ...
  const lowStockRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const timer = setTimeout(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Operational Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Configure working hours, payments & inventory" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-muted-foreground" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-muted-foreground uppercase tracking-wide", children: "Working Hours" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-4 border-t", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-muted-foreground uppercase tracking-wide", children: "Payment Methods" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: PAYMENT_METHODS.map((method) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: method, children: method }, method)) })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Allowed Payment Methods" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: PAYMENT_METHODS.map((method) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => handlePaymentMethodToggle(method),
              className: `px-3 py-1.5 rounded-full text-sm border transition-colors ${isPaymentMethodEnabled(method) ? "bg-primary text-primary-foreground border-primary" : "bg-background text-muted-foreground border-border hover:border-primary/50"}`,
              children: method
            },
            method
          )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-4 border-t", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-muted-foreground uppercase tracking-wide", children: "Inventory Settings" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              onChange: (e) => updateOperationsInfo({ lowStockThreshold: parseInt(e.target.value) || 0 }),
              autoComplete: "off"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Alert when stock falls below this quantity" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "stockValuationMethod", children: "Stock Valuation Method" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: STOCK_VALUATION_METHODS.map((method) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: method.value, children: method.label }, method.value)) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Method for calculating inventory cost" })
        ] })
      ] })
    ] })
  ] });
...
function SetupWizardScreen() {
  ...
  const { currentStep, nextStep, prevStep, completeSetup, isLoading, error, businessInfo } = useSetup();
  const renderCount = reactExports.useRef(0);
  renderCount.current += 1;
  reactExports.useEffect(() => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 3:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(BranchSetupStep, {});
      case 4:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TaxCurrencyStep, {});
      case 5:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(OperationsStep, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomeStep, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-background to-muted/30 flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "w-full max-w-3xl shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 sm:p-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mt-8 pt-6 border-t", children: [
        ...
        currentStep < 5 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleNext, disabled: !canProceed() || isLoading, children: [
          "Next",
