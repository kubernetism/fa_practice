import { c as createLucideIcon, z as React, j as jsxRuntimeExports, Q as useBranch, r as reactExports, q as RefreshCw, B as Button, a as LoaderCircle, v as Check, ai as Plus, Y as Tabs, Z as TabsList, _ as TabsTrigger, ah as TabsContent, k as Select, l as SelectTrigger, m as SelectValue, n as SelectContent, o as SelectItem, ab as Badge, a1 as DollarSign, aj as Trash2, $ as Card, ap as CardHeader, aq as CardTitle, ac as FileText, aC as CardDescription, a0 as CardContent, af as CreditCard, as as CircleCheckBig, au as CircleX, H as Receipt, a3 as Wallet, I as Input, a6 as Dialog, a7 as DialogContent, a8 as DialogHeader, a9 as DialogTitle, aa as DialogDescription, L as Label, p as Textarea, ak as DialogFooter } from "./index-DFJtak-X.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-CJXqgJvb.js";
...
import { P as Pencil } from "./pencil-BInhT9e8.js";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border overflow-hidden max-h-[400px] overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: cashFlowData.transactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 6, className: "text-center py-8 text-muted-foreground text-sm", children: "No transactions found for this period" }) }) : cashFlowData.transactions.map((txn) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "h-9", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1.5 text-xs", children: format(new Date(txn.createdAt), "MMM d, yyyy") }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1.5 text-xs text-muted-foreground", children: txn.referenceNumber || "-" })
                ] }, txn.id);
              }) })
            ] }) })
          ] })
