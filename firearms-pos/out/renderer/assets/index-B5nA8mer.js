import { t as useBranch, r as reactExports, j as jsxRuntimeExports, C as Card, b as CardHeader, c as CardTitle, o as Receipt, e as CardContent, D as DollarSign, ai as formatCurrency, I as Input, K as Select, M as SelectTrigger, ag as Building2, O as SelectValue, Q as SelectContent, V as SelectItem, a6 as CreditCard, L as Label, B as Button, X, ak as cn, am as FileText, a2 as Clock, ao as formatDateTime, g as Eye, H as RotateCcw, ap as ChevronRight, a7 as Dialog, a8 as DialogContent, a9 as DialogHeader, aa as DialogTitle, ab as DialogDescription, a5 as Separator, ad as DialogFooter, p as Banknote, a1 as Badge } from "./index-C_D_4RtI.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-De4R63KH.js";
import { R as ReversalStatusBadge, a as ReversalRequestModal } from "./reversal-status-badge-B6fZTozF.js";
import { T as TrendingUp } from "./trending-up-CBAw3Fhk.js";
import { C as Calendar } from "./calendar-CaDGm9gI.js";
import { S as Search } from "./search-BsWtoAus.js";
import { F as Filter } from "./filter-COAeSbB8.js";
import { B as Ban } from "./ban-CJSf1xfb.js";
import { P as Printer } from "./printer-DOWSAYie.js";
import { C as ChevronLeft } from "./chevron-left-BfLcnNEb.js";
import "./triangle-alert-2Pk65uWP.js";
import "./circle-check-Bnq4AC-a.js";
...
<div class="receipt-footer"><div class="thank-you">Thank you for your business!</div><div class="footer-sub">Printed: ${(/* @__PURE__ */ new Date()).toLocaleString()}<br>Powered by Firearms POS</div></div>
</body></html>`;
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "Gross Sales" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "All time gross sales" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "Today's Gross Sales" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Gross sales today" })
        ] })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: paginatedSales.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-40 items-center justify-center text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-right", children: "Tax" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-right", children: "Outstanding" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: paginatedSales.map((sale) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: cn(sale.isVoided && "opacity-50 bg-muted/50"), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("text-sm", sale.isVoided && "line-through"), children: formatCurrency(sale.taxAmount) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: sale.discountAmount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("text-sm text-green-600", sale.isVoided && "line-through"), children: [
          "-",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("font-medium", sale.isVoided && "line-through"), children: formatCurrency(sale.amountPaid) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: sale.totalAmount - sale.amountPaid > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("font-medium text-destructive", sale.isVoided && "line-through"), children: formatCurrency(sale.totalAmount - sale.amountPaid) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "-" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 pt-5 pb-4 text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold tracking-widest uppercase", children: "Firearms POS" }),
