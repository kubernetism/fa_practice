import { b as useBranch, r as reactExports, j as jsxRuntimeExports, B as Button, F as FileText, D as DollarSign, f as formatCurrency, i as Select, k as SelectTrigger, l as SelectValue, m as SelectContent, n as SelectItem, A as formatDate, C as CreditCard, g as ScrollArea } from "./index-DQY4_xAv.js";
...
import { C as CircleCheck } from "./circle-check-CU5C8EX6.js";
...
import { L as LoaderCircle } from "./loader-circle-DIX9O-_y.js";
import { D as Download } from "./download-CWi2Nd4t.js";
import { U as User } from "./user-CjPynxEQ.js";
import { C as CircleX } from "./circle-x-BTMWjc62.js";
...
Saved to: ${result.data.filePath}`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Payments received" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between pb-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-60 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-4 border-primary border-t-transparent" }) }) : receivables.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-60 flex-col items-center justify-center text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: receivables.map((receivable) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
