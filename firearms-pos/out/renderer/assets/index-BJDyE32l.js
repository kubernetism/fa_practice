import { Q as useBranch, r as reactExports, j as jsxRuntimeExports, Y as TooltipProvider, R as RotateCcw, aq as formatCurrency, a0 as DollarSign, a4 as Tooltip, a5 as TooltipTrigger, B as Button, q as RefreshCw, a6 as TooltipContent, aj as Plus, I as Input, X, ax as formatDateTime, ac as Badge, az as truncate, b as Eye, ak as Trash2, C as ChevronRight, a7 as Dialog, a8 as DialogContent, a9 as DialogHeader, aa as DialogTitle, ab as DialogDescription, L as Label, k as Select, l as SelectTrigger, m as SelectValue, n as SelectContent, o as SelectItem, p as Textarea, al as DialogFooter, af as Separator, f as CircleAlert } from "./index-CTCLjFkz.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table--Clhejk5.js";
import { R as ReversalRequestModal } from "./reversal-request-modal-XL8AbbGz.js";
import { C as Calendar } from "./calendar-Cn8UNX-e.js";
import { S as Search } from "./search-CKEJTk1Z.js";
import { P as Pencil } from "./pencil-LyByAWcG.js";
...
function ReturnsScreen() {
  ...
  const [editingReturn, setEditingReturn] = reactExports.useState(null);
  const [editRefundAmount, setEditRefundAmount] = reactExports.useState("");
      ...
      (prev) => prev.map((item) => {
        if (item.saleItem.id === saleItemId) {
          ...
          if (field === "returnQty") {
            ...
            updated.refundAmount = Math.round(effectiveUnitPrice * value * 100) / 100;
          }
          return updated;
        }
        return item;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: paginatedReturns.map((ret) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "group h-9", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1.5 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: "Edit Return" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isEditDialogOpen, onOpenChange: setIsEditDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { onOpenAutoFocus: (e) => e.preventDefault(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-5 w-5" }),
          "Edit Return"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Update the refund amount for this return. This will recalculate all related accounting entries." })
      ] }),
      editingReturn && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono font-medium", children: editingReturn.returnNumber }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
            formatDateTime(editingReturn.returnDate),
            " — Original: ",
            formatCurrency(editingReturn.refundAmount)
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Refund Amount *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
          ...
          editRefundAmount && !isNaN(parseFloat(editRefundAmount)) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-xs mt-1 ${parseFloat(editRefundAmount) !== editingReturn.refundAmount ? "text-amber-500" : "text-muted-foreground"}`, children: parseFloat(editRefundAmount) !== editingReturn.refundAmount ? `Change: ${formatCurrency(editingReturn.refundAmount)} → ${formatCurrency(parseFloat(editRefundAmount))} (difference: ${formatCurrency(parseFloat(editRefundAmount) - editingReturn.refundAmount)})` : "No change" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
