import { h as createLucideIcon, j as jsxRuntimeExports, i as Building2, S as Sparkles, k as Shield, l as useSetup, L as Label, I as Input, m as Select, n as SelectTrigger, o as SelectValue, p as SelectContent, q as SelectItem, T as Textarea, B as Button, s as Copy, t as UserPlus, u as useNavigate, r as reactExports, C as Card, e as CardContent, v as ChevronRight, w as LoaderCircle, x as Check } from "./index-CndH-dDJ.js";
...
function WelcomeStep() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold", children: "Welcome to Your POS System" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-md mx-auto", children: "Your complete Point of Sale & Inventory Management solution" })
    ] }),
...
function SetupWizardScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-background to-muted/30 flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t bg-background/80 backdrop-blur-sm py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4 text-center text-sm text-muted-foreground", children: "POS System - Initial Setup Wizard" }) })
  ] });
}
export {
  SetupWizardScreen
