import { c as createLucideIcon, r as reactExports, aw as useComposedRefs, as as useControllableState, j as jsxRuntimeExports, at as createContextScope, av as Primitive, ay as composeEventHandlers, aA as usePrevious, aB as useSize, aC as cn, Z as TooltipProvider, bn as FolderTree, a5 as Tooltip, a6 as TooltipTrigger, B as Button, s as RefreshCw, a7 as TooltipContent, ak as Plus, I as Input, X, Q as ScrollArea, ad as Badge, al as Trash2, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, L as Label, q as Textarea, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, am as DialogFooter, aX as ChevronDown, C as ChevronRight } from "./index-B52pgjeh.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-BFdpbqOp.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isDialogOpen, onOpenChange: setIsDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "isFirearm", children: "Firearm Category" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Products in this category must have firearm details (make, model, caliber)." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Switch,
              {
                ...
                onCheckedChange: (checked) => setFormData((prev) => ({ ...prev, isFirearm: checked }))
              }
            )
          ] })
        ] }),
