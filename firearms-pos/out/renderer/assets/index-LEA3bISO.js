import { c as createLucideIcon, b as useBranch, r as reactExports, j as jsxRuntimeExports, B as Button, k as Plus, n as Clock, W as Wallet, H as DollarSign, D as Dialog, o as DialogContent, p as DialogHeader, q as DialogTitle, s as DialogDescription, L as Label, I as Input, t as DialogFooter, O as Textarea, v as Select, w as SelectTrigger, x as SelectValue, y as SelectContent, z as SelectItem, l as Badge } from "./index-DnIY7vW3.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardContent, c as CardDescription } from "./card-D1PjFjWG.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DsoyQY0Y.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-WX8eC019.js";
import { R as RefreshCw } from "./refresh-cw-DQ0wp5bp.js";
import { f as format } from "./format-Bgkn8bop.js";
import { T as TrendingUp } from "./trending-up-_0zzuY_-.js";
import { T as TrendingDown } from "./trending-down-Bpx2WGNi.js";
import { C as Calendar } from "./calendar-D1Yq9Fe4.js";
import { C as CircleCheckBig } from "./circle-check-big-BfJHBXWS.js";
import { T as TriangleAlert } from "./triangle-alert-CO1X44Nj.js";
import { a as CircleArrowUp, C as CircleArrowDown } from "./circle-arrow-up-RxwoijVX.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Manage daily cash sessions and transactions" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: currentSession ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-2", children: [
            "Opened: ",
            format(new Date(currentSession.opened_at), "MMM d, h:mm a")
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: currentSession ? formatCurrency(currentSession.opening_balance) : "-" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between pb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "current", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: transactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8 text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: transactions.map((tx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: format(new Date(tx.transaction_date), "h:mm a") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              getTransactionIcon(tx.transaction_type),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize", children: tx.transaction_type.replace("_", " ") })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: tx.description || "-" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: tx.reference_type ? `${tx.reference_type} #${tx.reference_id}` : "-" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: `text-right font-medium ${["cash_in", "sale", "deposit"].includes(tx.transaction_type) ? "text-green-600" : "text-red-600"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "history", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: sessionHistory.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8 text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: sessionHistory.map((session) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: format(new Date(session.session_date), "MMM d, yyyy") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: getStatusBadge(session.status) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: session.openedByUser?.full_name || "-" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: formatCurrency(session.opening_balance) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: session.closing_balance !== null ? formatCurrency(session.closing_balance) : "-" }),
