import { c as createLucideIcon, b as useBranch, r as reactExports, j as jsxRuntimeExports, B as Button, P as Package, o as cn, f as formatCurrency, i as Select, k as SelectTrigger, p as Building2, l as SelectValue, m as SelectContent, n as SelectItem, q as ChevronRight, g as ScrollArea, s as formatDateTime } from "./index-DQY4_xAv.js";
        ...
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                status === "low" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-5 w-5 text-destructive" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Boxes, { className: "h-5 w-5 text-muted-foreground" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: row.productName }),
