import { d as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as RotateCcw, e as CircleAlert, B as Button, f as LoaderCircle, g as Building2, h as Sparkles, S as Shield, i as useSetup, L as Label, I as Input, k as Select, l as SelectTrigger, m as SelectValue, n as SelectContent, o as SelectItem, p as Textarea, M as MapPin, q as Copy, s as UserPlus, u as useNavigate, t as Check, T as ThemeToggle, C as ChevronRight } from "./index-DpTu8Ooe.js";
...
function WelcomeStep({ onRestoreComplete }) {
  ...
  const handleRestore = async () => {
    ...
    try {
      ...
      if (result.success) {
        setRestoreResult({ success: true, message: result.message || "Database restored successfully." });
        setTimeout(() => {
          onRestoreComplete?.();
        }, 2e3);
      } else {
