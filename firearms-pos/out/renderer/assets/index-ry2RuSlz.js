import { V as useBranch, d as useAuth, u as useNavigate, r as reactExports, j as jsxRuntimeExports, Z as TooltipProvider, aZ as formatCurrency, B as Button, s as RefreshCw, _ as Tabs, $ as TabsList, a0 as TabsTrigger, aj as TabsContent, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, b7 as formatDate, a5 as Tooltip, a6 as TooltipTrigger, b as Eye, a7 as TooltipContent, R as RotateCcw, ah as CreditCard, C as ChevronRight, a3 as Card, aV as CardHeader, aW as CardTitle, a4 as CardContent, ad as Badge, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, L as Label, I as Input, am as DialogFooter, h as Building2, Q as ScrollArea, b0 as CircleX, a1 as DollarSign, af as Clock } from "./index-B52pgjeh.js";
        ...
        const withPoNumbers = await Promise.all(
          rows.map(async (row) => {
            ...
            try {
              ...
              return {
                ...row,
                purchaseOrderNumber: poRes?.success && poRes.data?.purchaseOrderNumber ? poRes.data.purchaseOrderNumber : null
              };
            } catch {
...
Flagged for review: ${result.flagged.length}`
            ...
            children: "Reconcile with Purchases"
          }
        ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "list", className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border overflow-hidden", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-32 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6 w-6 animate-spin rounded-full border-2 border-primary border-t-transparent" }) }) : payables.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-32 items-center justify-center text-sm text-muted-foreground", children: "No payables found" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30 hover:bg-muted/30", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-[10px] font-semibold uppercase tracking-wider", children: "Source" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: payables.map((payable) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "group h-9", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1.5 text-xs", children: payable.purchaseOrderNumber ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "link",
                className: "h-auto p-0 font-mono text-xs",
                onClick: () => navigate(`/purchases?focus=${payable.purchaseId}`),
                children: payable.purchaseOrderNumber
              }
