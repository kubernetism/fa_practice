...
const ReportCard = React.forwardRef(
  ({ businessName, branchName, periodLabel, generatedAt, formatCurrency, formatNumber: formatNumber2, stats }, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col gap-3 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs, { value: timePeriod, onValueChange: (v2) => setTimePeriod(v2), children: /* @__PURE__ */ jsxRuntimeExports.jsx(TabsList, { className: "h-7", children: Object.keys(TIME_PERIOD_LABELS).map((period) => /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: period, className: "text-xs px-2.5 h-5", children: TIME_PERIOD_LABELS[period] }, period)) }) })
      ] })
    ] }),
