import { V as useBranch, ai as useCurrentBranchSettings, r as reactExports, j as jsxRuntimeExports, J as Receipt, ag as Separator, aZ as formatCurrency, I as Input, X, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, aC as cn, b1 as formatDateTime, b as Eye, a as LoaderCircle, R as RotateCcw, C as ChevronRight, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, B as Button, L as Label, am as DialogFooter, a1 as DollarSign, ah as CreditCard, O as Banknote, ad as Badge } from "./index-B52pgjeh.js";
  ...
  const getPaymentStatusBadge = (status, isVoided) => {
    ...
    switch (status) {
      ...
      case "pending_approval":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-amber-500/20 text-amber-300 border border-amber-500/40", children: "Awaiting Approval" });
      case "cancelled":
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 border-b border-border bg-card px-4 py-2 space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterPaymentStatus, onValueChange: (v) => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-7 w-36 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Status" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "pending_approval", children: "Awaiting Approval" }),
