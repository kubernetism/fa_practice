import { V as useBranch, u as useNavigate, r as reactExports, j as jsxRuntimeExports, Z as TooltipProvider, a1 as DollarSign, B as Button, ak as Plus, I as Input, X, a5 as Tooltip, a6 as TooltipTrigger, s as RefreshCw, a7 as TooltipContent, b7 as formatDate, ad as Badge, aC as cn, al as Trash2, R as RotateCcw, C as ChevronRight, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, L as Label, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, q as Textarea, am as DialogFooter } from "./index-B52pgjeh.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-cijvxAEp.js";
import { R as ReversalRequestModal } from "./reversal-request-modal-Bj3gHh6K.js";
import { R as ReversalStatusBadge } from "./reversal-status-badge-By3IVMYo.js";
...
import "./ban-BvMsSnNU.js";
import "./circle-check-BOgu7Fvm.js";
...
function ExpensesScreen() {
  ...
  const [payeesList, setPayeesList] = reactExports.useState([]);
  ...
  const fetchPayees = reactExports.useCallback(async () => {
    try {
      const response = await window.api.payees.getAll({ isActive: true, limit: 1e3 });
  ...
  const fetchRegisterState = reactExports.useCallback(async () => {
    if (!currentBranch) {
  ...
  const filteredExpenses = reactExports.useMemo(() => {
    ...
    return sorted.filter((exp) => {
      return exp.category?.name.toLowerCase().includes(term) || exp.description?.toLowerCase().includes(term) || exp.payee?.name.toLowerCase().includes(term) || exp.reference?.toLowerCase().includes(term) || exp.paymentMethod?.toLowerCase().includes(term);
    });
  }, [expenses, searchTerm]);
  ...
  const handleSubmit = async (e) => {
    ...
    const isCashPayment = formData.paymentStatus === "paid" && (!formData.paymentMethod || formData.paymentMethod === "cash");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    registerOpen === false && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        role: "alert",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold", children: "Cash register is closed." }),
            " ",
            "You can create unpaid expenses, but paid-in-cash expenses will be rejected until a register session is opened for this branch."
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30 hover:bg-muted/30", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-[10px] font-semibold tracking-wider uppercase h-8 py-0", children: "Payee" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: pageExpenses.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 9, className: "h-24 text-center text-sm text-muted-foreground", children: searchTerm ? "No expenses match your search." : 'No expenses yet. Click "Add Expense" to get started.' }) }) : pageExpenses.map((expense) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "h-9 group", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1.5 text-xs text-muted-foreground", children: expense.payee ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize text-muted-foreground/60 text-[10px] mr-1", children: expense.payee.payeeType }),
          expense.payee.name,
          expense.paymentStatus === "unpaid" && expense.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "block text-[10px] text-muted-foreground/60", children: [
            "Due: ",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col flex-1 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-3 overflow-y-auto px-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "payee", children: "Payee *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Select,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select who this expense was paid to" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: payeesList.map((payee) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: payee.id.toString(), children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize text-muted-foreground text-[10px] mr-1", children: payee.payeeType }),
                        payee.name
                      ] }, payee.id)) })
                    ]
                  }
                ),
                payeesList.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "No payees available. Add payees via the Payees screen first." })
              ] }),
