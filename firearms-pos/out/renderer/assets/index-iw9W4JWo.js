import { u as useNavigate, a as useAuth, r as reactExports, j as jsxRuntimeExports, N as Navigate, C as Card, b as CardHeader, c as CardTitle, d as CardDescription, e as CardContent, L as Label, U as User, I as Input, f as Lock, E as EyeOff, g as Eye, B as Button } from "./index-DIp0wFLY.js";
function LoginScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-muted/30 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "space-y-1 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl font-bold", children: businessName }),
