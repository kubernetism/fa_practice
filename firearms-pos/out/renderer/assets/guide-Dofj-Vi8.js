import { c as createLucideIcon, aP as useTheme, r as reactExports, bh as LayoutDashboard, G as ShoppingCart, P as Package, bi as Warehouse, H as Receipt, A as Users, R as RotateCcw, F as Truck, aV as FolderTree, af as CreditCard, a3 as Wallet, J as Banknote, az as BadgePercent, ac as FileText, a4 as Percent, bj as BookOpen, W as Wrench, aA as UserCog, ar as ClipboardList, aD as FileChartColumnIncreasing, D as Settings, bk as Store, S as Shield, j as jsxRuntimeExports, I as Input, aF as ChevronDown, C as ChevronRight, ai as Plus, ad as Clock } from "./index-DFJtak-X.js";
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent } from "./tooltip-CqrPwlNm.js";
import { U as UserCheck } from "./user-check-CZaFv6VE.js";
import { C as ChartColumn } from "./chart-column-DaMEo34y.js";
import { B as Building } from "./building-BkzUo7V6.js";
import { T as TriangleAlert } from "./triangle-alert-DL8Bls2H.js";
import { P as Play } from "./play-CJsIC9i9.js";
import { T as TrendingUp } from "./trending-up-Dxm5e8qB.js";
import { C as Calculator } from "./calculator-CH8pIQEU.js";
import { S as Search } from "./search-DjKKS3we.js";
import { M as Minus } from "./minus-CIuDFTq9.js";
import { C as ChevronLeft } from "./chevron-left-BDWQX7J8.js";
/**
...
const THEME_COLORS = {
  light: {
    ...
    text: "oklch(0.10 0 0)",
    /* dark black text */
    textMuted: "oklch(0.20 0 0)",
    /* very dark paragraphs */
  ...
  dark: {
    ...
    text: "oklch(0.97 0 0)",
    /* white text */
    textMuted: "oklch(0.88 0 0)",
    /* near-white paragraphs */
...
function estimateReadTime(section) {
...
const guideSections = [
  ...
  {
    id: "receivables",
    title: { en: "Receivables", ur: "قابل وصول" },
    icon: Wallet,
    category: "financial",
  ...
  {
    id: "common-issues",
    title: { en: "Common Issues", ur: "عام مسائل" },
    icon: TriangleAlert,
    category: "management",
...
const categoryOrder = ["operations", "financial", "accounting", "management"];
function getCategoryMeta(accent) {
  return {
...
function Ornament({ className = "", c }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-3 my-6 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px", style: { background: `linear-gradient(to right, transparent, ${c.borderSubtle}, transparent)` } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full opacity-50", style: { background: c.accent } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rotate-45 opacity-70", style: { background: c.accent } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full opacity-50", style: { background: c.accent } })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px", style: { background: `linear-gradient(to right, transparent, ${c.borderSubtle}, transparent)` } })
  ] });
}
function ConceptBox({ concept, lang, c, font }) {
  const isUrdu = lang === "ur";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-6 rounded-lg overflow-hidden", style: {
    borderLeft: isUrdu ? "none" : `3px solid ${c.accent}`,
    borderRight: isUrdu ? `3px solid ${c.accent}` : "none",
    background: c.bgElevated
  }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-3 flex items-center gap-3", style: { borderBottom: `1px solid ${c.border}`, background: c.bgSunken }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-4 h-4 shrink-0", style: { color: c.accent } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold tracking-wide", style: { color: c.accent, fontFamily: font }, children: t(concept.term, lang) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold uppercase tracking-[0.3em] block mb-1.5", style: { color: c.accent }, children: isUrdu ? "آسان مثال" : "Think of it as..." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "leading-[1.9] italic opacity-80", style: { fontFamily: font }, children: [
          "“",
          t(concept.analogy, lang),
          "”"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px", style: { background: c.border } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold uppercase tracking-[0.3em] block mb-1.5", style: { color: c.info }, children: isUrdu ? "تعریف" : "Formal Definition" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-[1.9] opacity-70", children: t(concept.definition, lang) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px", style: { background: c.border } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold uppercase tracking-[0.3em] block mb-1.5", style: { color: c.success }, children: isUrdu ? "ایپ میں کہاں ملے گا" : "Where to Find It" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-[1.9] opacity-70", children: t(concept.inApp, lang) })
      ] })
    ] })
  ] });
}
function GuideScreen() {
  ...
  const [fontSize, setFontSize] = reactExports.useState(15);
  const [tocSearch, setTocSearch] = reactExports.useState("");
  const [currentPage, setCurrentPage] = reactExports.useState(0);
  const [tocCollapsed, setTocCollapsed] = reactExports.useState(false);
  ...
  const [visited, setVisited] = reactExports.useState(/* @__PURE__ */ new Set([0]));
  const [collapsedCategories, setCollapsedCategories] = reactExports.useState(/* @__PURE__ */ new Set());
  const readingRef = reactExports.useRef(null);
  ...
  const navigateTo = reactExports.useCallback((pageIdx) => {
    setCurrentPage(pageIdx);
    readingRef.current?.scrollTo({ top: 0, behavior: "smooth" });
  }, []);
  const toggleBookmark = reactExports.useCallback((page) => {
    setBookmarks((prev) => {
  ...
  const toggleCategory = reactExports.useCallback((cat) => {
  ...
  const filteredSections = reactExports.useMemo(() => {
    ...
    return guideSections.filter(
      (s) => t(s.title, lang).toLowerCase().includes(q) || t(s.summary, lang).toLowerCase().includes(q)
    );
  }, [tocSearch, lang]);
  const currentEntry = tocEntries[currentPage];
  const readingProgress = Math.round(Array.from(visited).length / totalPages * 100);
  const getRelatedChapters = reactExports.useCallback((sectionId) => {
    const parentPhase = workflowPhases.find((p) => p.modules.includes(sectionId));
    if (!parentPhase) return [];
    return parentPhase.modules.filter((m) => m !== sectionId).map((m) => guideSections.find((s) => s.id === m)).filter(Boolean);
  }, []);
  ...
  function renderPage() {
    ...
    if (currentEntry.type === "intro") {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center pt-12 pb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-20 h-20 mx-auto mb-8 rounded-full flex items-center justify-center",
              style: { border: `2px solid ${c.border}`, background: c.bgElevated },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookMarked, { className: "w-9 h-9", style: { color: c.accent } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold uppercase tracking-[0.5em] mb-4", style: { color: c.textFaint }, children: isUrdu ? "فائر آرمز POS سسٹم" : "Firearms POS System" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold mb-2 tracking-tight", style: { fontFamily: font, color: c.accentGlow }, children: isUrdu ? "ارمرر کا دستور" : "The Armorer's Codex" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-2", style: { fontFamily: font, color: c.textFaint }, children: isUrdu ? "مکمل استعمال کی گائیڈ" : "Complete Operational Guide" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Ornament, { c }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-lg mx-auto leading-[1.9] mt-6", style: { fontFamily: font, color: c.textMuted }, children: t(workflowIntro, lang) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ornament, { c }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-lg font-bold mb-5 flex items-center gap-3", style: { fontFamily: font, color: c.text }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-5 h-5", style: { color: c.accent } }),
            isUrdu ? "یہ گائیڈ کیسے استعمال کریں" : "How to Navigate This Guide"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 leading-[1.9]", style: { fontFamily: font, color: c.textMuted }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: isUrdu ? 'بائیں طرف فہرست مضامین ہے۔ کسی بھی باب پر کلک کریں یا نیچے "اگلا" بٹن سے ترتیب سے پڑھیں۔ پہلے 6 "حصے" کاروبار کے ورک فلو کا جائزہ دیتے ہیں، پھر ہر ماڈیول کا تفصیلی باب ہے۔' : 'The table of contents is on the left. Click any chapter to jump directly, or read in order using the "Next" button. The first 6 "Parts" give you a workflow overview, followed by detailed chapters for each module.' }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: isUrdu ? 'حسابات کے ابواب میں خاص "تصور سمجھیں" خانے ہیں جو مشکل اصطلاحات آسان مثالوں سے سمجھاتے ہیں۔' : 'Accounting chapters include special "Concept" boxes that explain difficult terms with everyday analogies — no prior accounting knowledge needed.' })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg p-5 mt-6", style: { background: c.bgElevated, border: `1px solid ${c.border}` }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Keyboard, { className: "w-4 h-4", style: { color: c.info } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", style: { color: c.info }, children: isUrdu ? "کی بورڈ شارٹ کٹس" : "Keyboard Shortcuts" })
          ] }),
          ...
          ].map(({ keys, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "px-2 py-0.5 rounded text-[10px] font-mono font-bold", style: { background: c.bgSunken, border: `1px solid ${c.border}` }, children: keys }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: c.textFaint }, children: desc })
          ] }, keys)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mt-8", children: [
        ...
        ].map(({ label, value, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-4 rounded-lg", style: { background: c.bgElevated, border: `1px solid ${c.border}` }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold tabular-nums", style: { fontFamily: font, color }, children: value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest mt-1", style: { color: c.textFaint }, children: label })
        ] }, label)) })
      ] });
    }
    if (currentEntry.type === "phase") {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative text-center pt-8 pb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: currentEntry.phaseIdx + 1
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-[0.5em]", style: { color: c.accentDim }, children: isUrdu ? `حصہ ${currentEntry.phaseIdx + 1}` : `Part ${currentEntry.phaseIdx + 1}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "w-16 h-16 mx-auto my-6 rounded-full flex items-center justify-center",
                style: { border: `2px solid ${c.border}`, background: c.bgElevated },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(PhaseIcon, { className: "w-7 h-7", style: { color: c.accent } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-2", style: { fontFamily: font, color: c.text }, children: t(phase.title, lang) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Ornament, { c }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-md mx-auto leading-[1.9] mt-4", style: { fontFamily: font, color: c.textMuted }, children: t(phase.description, lang) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-bold uppercase tracking-[0.3em] mb-5", style: { color: c.accent }, children: isUrdu ? "اس حصے کے ابواب" : "Chapters in this Part" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: phase.modules.map((modId, idx) => {
            const section2 = guideSections.find((s) => s.id === modId);
            if (!section2) return null;
            const sectionIdx = guideSections.indexOf(section2);
            const pageIdx = tocEntries.findIndex((e) => e.type === "chapter" && e.sectionIdx === sectionIdx);
            const SectionIcon2 = section2.icon;
            const readTime2 = estimateReadTime(section2);
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold tabular-nums w-5 shrink-0", style: { fontFamily: font, color: c.textMuted }, children: idx + 1 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "w-10 h-10 rounded-lg flex items-center justify-center shrink-0 transition-colors",
                      style: { background: c.bgSunken, border: `1px solid ${c.borderSubtle}` },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionIcon2, { className: "w-5 h-5", style: { color: c.text } })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-base", style: { fontFamily: font, color: c.text }, children: t(section2.title, lang) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1 truncate", style: { color: c.textMuted }, children: t(section2.summary, lang) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 shrink-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs tabular-nums", style: { color: c.textMuted }, children: [
                      section2.steps.length,
                      " ",
                      isUrdu ? "مراحل" : "steps"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs flex items-center gap-1", style: { color: c.textMuted }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3" }),
                      readTime2,
                      "m"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 opacity-30 group-hover:opacity-60 transition-opacity", style: { color: c.textMuted } })
                  ] })
                ]
              },
              modId
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative text-center pt-6 pb-6 mb-8", style: { borderBottom: `1px solid ${c.border}` }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0 flex items-center justify-center pointer-events-none select-none opacity-[0.04]",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-[0.4em]", style: { color: c.accentDim }, children: isUrdu ? `باب ${chapterNum}` : `Chapter ${chapterNum}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: isUrdu ? catMeta.ur : catMeta.en
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: { border: `2px solid ${c.border}`, background: c.bgElevated },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionIcon, { className: "w-5 h-5", style: { color: catMeta.color } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-1", style: { fontFamily: font, color: c.text }, children: t(section.title, lang) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1 flex items-center justify-center gap-3", style: { color: c.textFaint }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t(section.summary, lang) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mt-3 text-[10px]", style: { color: c.textFaint }, children: [
            ...
            section.concepts && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              section.concepts.length,
              " ",
              isUrdu ? "تصورات" : "concepts"
            ] })
          ] })
        ] })
      ] }),
      section.steps.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 rounded-lg p-5", style: { background: c.bgElevated, border: `1px solid ${c.border}` }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[10px] font-bold uppercase tracking-[0.3em] mb-3", style: { color: c.accentDim }, children: isUrdu ? "اس باب میں آپ سیکھیں گے" : "What You Will Learn" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `grid gap-1.5 ${section.steps.length > 4 ? "grid-cols-2" : "grid-cols-1"}`, children: section.steps.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-2 text-sm ${isUrdu ? "flex-row-reverse text-right" : ""}`, style: { color: c.textMuted }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold tabular-nums mt-0.5 shrink-0", style: { color: c.accent }, children: [
            idx + 1,
            "."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t(step.title, lang) })
        ] }, idx)) })
      ] }),
      section.concepts && section.concepts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-bold mb-4 flex items-center gap-2", style: { fontFamily: font, color: c.accent }, children: [
        ...
        section.concepts.map((concept, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ConceptBox, { concept, lang, c, font }, i))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ornament, { c }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[10px] font-bold uppercase tracking-[0.3em] mb-6", style: { color: c.accentDim }, children: isUrdu ? "مرحلہ وار گائیڈ" : "Step-by-Step Guide" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0", children: section.steps.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex gap-5 ${isUrdu ? "flex-row-reverse" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
            ...
            idx < section.steps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px flex-1 my-2", style: {
              background: c.borderSubtle
            } })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `pb-7 flex-1 ${isUrdu ? "text-right" : ""}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold mb-1.5", style: { fontFamily: font, color: c.text }, children: t(step.title, lang) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-[1.9]", style: { fontFamily: font, color: c.textMuted }, children: t(step.description, lang) })
          ] })
        ] }, idx)) })
      ] }),
      section.examples && section.examples.length > 0 && section.examples.map((ex, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 rounded-lg overflow-hidden", style: { border: `1px solid ${c.border}`, background: c.bgElevated }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-3 flex items-center gap-2", style: { borderBottom: `1px solid ${c.border}`, background: c.bgSunken }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3.5 h-3.5", style: { color: c.info } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", style: { color: c.info, fontFamily: font }, children: t(ex.label, lang) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: ex.fields.map((f, fi) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-baseline gap-4 text-sm ${isUrdu ? "flex-row-reverse" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "min-w-[120px] text-xs uppercase tracking-wider", style: { color: c.textFaint }, children: t(f.name, lang) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-semibold text-sm", style: { color: c.info }, children: f.value })
        ] }, fi)) }) })
      ] }, idx)),
      section.tips && section.tips.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 rounded-lg p-5", style: { borderLeft: isUrdu ? "none" : `3px solid ${c.success}`, borderRight: isUrdu ? `3px solid ${c.success}` : "none", background: c.bgElevated }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-4 h-4", style: { color: c.success } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", style: { color: c.success, fontFamily: font }, children: isUrdu ? "ماہرانہ مشورے" : "Pro Tips" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: section.tips.map((tip, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 ${isUrdu ? "flex-row-reverse text-right" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: `w-3.5 h-3.5 shrink-0 mt-1.5 ${isUrdu ? "rotate-180" : ""}`, style: { color: c.success } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-[1.8]", style: { fontFamily: font, color: c.textMuted }, children: t(tip, lang) })
        ] }, i)) })
      ] }),
      section.warnings && section.warnings.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 rounded-lg p-5", style: { borderLeft: isUrdu ? "none" : `3px solid ${c.warning}`, borderRight: isUrdu ? `3px solid ${c.warning}` : "none", background: c.bgElevated }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-4 h-4", style: { color: c.warning } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", style: { color: c.warning, fontFamily: font }, children: isUrdu ? "اہم تنبیہ" : "Important Warning" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: section.warnings.map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 ${isUrdu ? "flex-row-reverse text-right" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3.5 h-3.5 shrink-0 mt-1.5", style: { color: c.warning, opacity: 0.6 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-[1.8]", style: { fontFamily: font, color: c.textMuted }, children: t(w, lang) })
        ] }, i)) })
      ] }),
      related.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ornament, { c }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-[10px] font-bold uppercase tracking-[0.3em] mb-4 flex items-center gap-2", style: { color: c.accentDim }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { className: "w-3.5 h-3.5" }),
            isUrdu ? "متعلقہ ابواب" : "Related Chapters"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: related.map((rel) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                style: { background: c.bgElevated, border: `1px solid ${c.border}` },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(RelIcon, { className: "w-3.5 h-3.5", style: { color: c.textMuted } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontFamily: font, color: c.text }, children: t(rel.title, lang) })
                ]
              },
              rel.id
            );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipProvider, { delayDuration: 300, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative flex -m-6 overflow-hidden ${isUrdu ? "font-urdu" : ""}`, style: { background: c.bg, color: c.text, zoom: fontSize / 15, fontFamily: font, height: `calc(100% + 3rem)` }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "aside",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 pb-3 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(BookMarked, { className: "w-4 h-4", style: { color: c.accent } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-[0.25em]", style: { color: c.accent }, children: isUrdu ? "فہرست مضامین" : "Contents" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] tabular-nums", style: { color: c.textFaint }, children: [
                  readingProgress,
                  "%"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 rounded-full mb-3", style: { background: c.border }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full rounded-full transition-all duration-500", style: { width: `${readingProgress}%`, background: c.accent } }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5", style: { color: c.textFaint } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ref: searchRef,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto toc-scroll px-2 pb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  onClick: () => navigateTo(0),
                  className: `w-full text-left px-3 py-2.5 rounded-md text-sm font-medium mb-2 transition-all flex items-center gap-2 ${currentPage === 0 ? "" : "opacity-50 hover:opacity-75"}`,
                  style: currentPage === 0 ? { background: c.bgElevated, color: c.accent } : { color: c.text },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(BookMarked, { className: "w-3 h-3 shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontFamily: font }, children: isUrdu ? "تعارف" : "Introduction" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-[0.3em] px-3 block mb-1", style: { color: c.textFaint }, children: isUrdu ? "ورک فلو" : "Workflow" }),
                workflowPhases.map((phase, idx) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    {
                      onClick: () => navigateTo(pageIdx),
                      className: `w-full text-left px-3 py-2 rounded-md text-sm transition-all flex items-center gap-2 ${isActive ? "font-semibold" : isVisited ? "opacity-60 hover:opacity-80" : "opacity-40 hover:opacity-65"}`,
                      style: isActive ? { background: c.bgElevated, color: c.accent } : { color: c.text },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs w-3 shrink-0 tabular-nums", style: { fontFamily: font, color: c.textFaint }, children: idx + 1 }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(PhIcon, { className: "w-3.5 h-3.5 shrink-0", style: { color: c.textMuted } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", style: { fontFamily: font }, children: t(phase.title, lang) }),
                        isVisited && !isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full shrink-0 ml-auto", style: { background: c.accent } })
                      ]
                    },
                    phase.id
                  );
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: `w-3 h-3 transition-transform ${isCollapsed ? "-rotate-90" : ""}`, style: { color: c.textFaint } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-[0.3em]", style: { color: meta.color }, children: isUrdu ? meta.ur : meta.en }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] ml-auto", style: { color: c.textFaint }, children: sections.length })
                      ]
                    }
                  ),
                  !isCollapsed && sections.map((section) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-3.5 h-3.5 shrink-0", style: { color: c.textMuted } }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", style: { fontFamily: font }, children: t(section.title, lang) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 ml-auto shrink-0", children: [
                            isBookmarked && /* @__PURE__ */ jsxRuntimeExports.jsx(Bookmark, { className: "w-2.5 h-2.5", style: { color: c.accent, fill: c.accent } }),
                            isVisited && !isActive && !isBookmarked && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full", style: { background: meta.color } })
                          ] })
                        ]
                      },
                      section.id
      ...
      !tocCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[3px] shrink-0", style: {
        background: `linear-gradient(to bottom, transparent, ${c.accent}, transparent)`,
        opacity: 0.3
      } }),
      tocCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4", style: { color: c.accent } })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", className: "text-xs", children: isUrdu ? "فہرست دکھائیں" : "Show contents" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-2 shrink-0", style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4", style: { color: c.textFaint } })
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "bottom", className: "text-xs", children: tocCollapsed ? "Show contents" : "Hide contents" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] tabular-nums", style: { fontFamily: font, color: c.textFaint }, children: [
              currentPage + 1,
              " / ",
              totalPages
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "bottom", className: "text-xs", children: bookmarks.has(currentPage) ? "Remove bookmark (B)" : "Bookmark this page (B)" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center rounded-md", style: { border: `1px solid ${c.border}` }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-6 text-center tabular-nums", style: { color: c.textFaint }, children: fontSize }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Languages, { className: "w-3.5 h-3.5", style: { color: c.textFaint } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", style: { color: c.text }, children: lang === "en" ? "اردو" : "English" })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            dir: isUrdu ? "rtl" : "ltr",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-12 py-10", children: renderPage() })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-3 shrink-0", style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-3.5 h-3.5 shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", style: { color: c.textMuted }, children: currentPage > 0 ? getPageLabel(currentPage - 1) : isUrdu ? "پچھلا" : "Previous" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] uppercase tracking-[0.2em]", style: { fontFamily: font, color: c.textFaint }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] mt-0.5 flex items-center justify-center gap-1", style: { color: c.textFaint }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "← →" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: { border: `1px solid ${c.border}`, color: c.text },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", style: { color: c.textMuted }, children: currentPage < totalPages - 1 ? getPageLabel(currentPage + 1) : isUrdu ? "اگلا" : "Next" }),
