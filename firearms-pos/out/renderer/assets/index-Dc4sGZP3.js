import { b as useBranch, r as reactExports, j as jsxRuntimeExports, B as Button, h as Plus, D as DollarSign, f as formatCurrency, I as Input, m as Clock, G as formatDateTime, H as FileText, K as truncate, T as Trash2, F as ChevronRight, n as Dialog, o as DialogContent, p as DialogHeader, q as DialogTitle, s as DialogDescription, L as Label, v as Select, w as SelectTrigger, x as SelectValue, y as SelectContent, z as SelectItem, X, M as Textarea, t as DialogFooter, i as Badge, C as CircleAlert } from "./index-B-7-7O_y.js";
...
import { R as RotateCcw } from "./rotate-ccw-Bkrcfkmp.js";
  ...
  const fetchData = reactExports.useCallback(async () => {
    try {
      ...
      const [returnsResult, salesResult, productsResult, customersResult, usersResult] = await Promise.all([
        window.api.returns.getAll({ limit: 1e3 }),
      ...
      if (salesResult.success && salesResult.data) {
        setSales(salesResult.data.filter((s) => !s.isVoided));
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Process and manage product returns from sales" })
      ] }),
