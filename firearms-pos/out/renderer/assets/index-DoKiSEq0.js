import { c as createLucideIcon, V as useBranch, d as useAuth, r as reactExports, j as jsxRuntimeExports, s as RefreshCw, B as Button, ak as Plus, a3 as Card, aV as CardHeader, aW as CardTitle, a_ as ClipboardList, a4 as CardContent, a$ as CircleCheckBig, aZ as formatCurrency, aC as cn, b0 as CircleX, ae as FileText, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, L as Label, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, I as Input, q as Textarea, am as DialogFooter, Q as ScrollArea, b1 as formatDateTime, ad as Badge, Z as TooltipProvider, P as Package, a5 as Tooltip, a6 as TooltipTrigger, a7 as TooltipContent, X, h as Building2, b as Eye, al as Trash2, C as ChevronRight, ag as Separator } from "./index-B52pgjeh.js";
...
function InventoryScreen() {
  ...
  const [defaultMinStockAlert, setDefaultMinStockAlert] = reactExports.useState(5);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const minStockChanged = Number.isFinite(minStockAlert) && minStockAlert >= 0 && (!editingInventory || editingInventory.minQuantity !== minStockAlert);
      if (editingInventory) {
