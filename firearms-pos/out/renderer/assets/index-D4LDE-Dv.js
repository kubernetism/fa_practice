import { r as reactExports, j as jsxRuntimeExports, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, a as LoaderCircle, B as Button, ad as Badge, Q as ScrollArea, ae as FileText, af as Clock, U as User, ag as Separator, W as Wrench, ah as CreditCard, V as useBranch, Y as useCurrency, ai as useCurrentBranchSettings, _ as Tabs, $ as TabsList, a0 as TabsTrigger, P as Package, I as Input, X, aj as TabsContent, g as CircleAlert, J as Receipt, ak as Plus, al as Trash2, Z as TooltipProvider, a5 as Tooltip, a6 as TooltipTrigger, a7 as TooltipContent, O as Banknote, G as Truck, v as UserPlus, L as Label, am as DialogFooter, an as Ticket, ao as Percent, ap as Phone, M as MapPin, a1 as DollarSign, h as Building2, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem } from "./index-B52pgjeh.js";
import { C as Checkbox } from "./checkbox-CnYDELrb.js";
import { C as CircleCheck } from "./circle-check-BOgu7Fvm.js";
import { P as Printer } from "./printer-2YufhzqH.js";
...
import { S as Smartphone } from "./smartphone-D_CNt3jE.js";
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  ...
                  (item.modelName || item.caliberName || item.make) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] leading-tight text-muted-foreground truncate", children: [item.modelName, item.caliberName, item.make].filter(Boolean).join(" · ") }),
...
Card: **** **** **** ${cardLastFourDigits}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "theme-agentfactory flex h-full gap-1.5 -m-6 p-3 overflow-hidden bg-background text-foreground", children: [
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              (() => {
                const caliberName = item.product._caliberName;
                return caliberName ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-1 rounded-full bg-primary/10 px-1.5 py-0.5 text-[9px] font-mono", children: caliberName }) : null;
              })(),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-80 xl:w-[22rem] 2xl:w-[24rem] flex flex-col rounded-lg border border-border bg-card overflow-hidden shrink-0", children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                (() => {
                  ...
                  return parts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground/70 truncate", children: parts.join(" · ") }) : null;
                })(),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "min-w-[4rem] text-right text-[11px] font-semibold tabular-nums shrink-0 whitespace-nowrap", children: formatCurrency2(lineTotal) })
            ]
          },
