import { h as createLucideIcon, j as jsxRuntimeExports, r as reactExports, a5 as createContextScope, a6 as createPopperScope, a7 as useId, a8 as useControllableState, a9 as Root2, aa as useComposedRefs, ab as Anchor, ac as Primitive, ad as composeEventHandlers, ae as Presence, af as Portal$1, ag as DismissableLayer, ah as Content, ai as Root, aj as Arrow, ak as cn, al as Dialog, am as DialogContent, an as DialogHeader, ao as DialogTitle, ap as DialogDescription, w as LoaderCircle, B as Button, aq as Badge, ar as ScrollArea, as as FileText, at as Clock, U as User, au as Separator, W as Wrench, av as CreditCard, Q as useBranch, V as useCurrency, aw as useCurrentBranchSettings, Y as Tabs, Z as TabsList, _ as TabsTrigger, P as Package, I as Input, X, ax as TabsContent, ay as CircleAlert, J as Receipt, az as Plus, aA as Trash2, K as Banknote, G as Truck, t as UserPlus, L as Label, aB as DialogFooter, aC as Ticket, a3 as Percent, aD as Phone, $ as DollarSign, i as Building2, m as Select, n as SelectTrigger, o as SelectValue, p as SelectContent, q as SelectItem } from "./index-BaWw62T2.js";
...
Card: **** **** **** ${cardLastFourDigits}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full gap-3 -m-6 p-3 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 flex-col min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: (value) => setActiveTab(value), className: "flex flex-col h-full", children: [
