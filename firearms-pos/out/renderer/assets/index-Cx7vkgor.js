import { b as useBranch, r as reactExports, e as debounce, j as jsxRuntimeExports, I as Input, g as ScrollArea, h as Plus, i as Badge, f as formatCurrency, P as Package, B as Button, X, C as CircleAlert, T as Trash2, k as Banknote, l as CreditCard, m as Clock, n as Dialog, o as DialogContent, p as DialogHeader, q as DialogTitle, s as DialogDescription, L as Label, t as DialogFooter, R as Receipt } from "./index-B-7-7O_y.js";
...
Address: ${codAddress}, ${codCity}`;
      ...
      if (result.success) {
        const shouldCreateReceivable = paymentMethod === "receivable" && selectedCustomer || paymentStatus === "partial" && selectedCustomer && remainingAmount > 0;
