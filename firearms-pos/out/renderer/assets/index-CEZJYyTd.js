import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, R as RotateCcw, aZ as formatCurrency, q as Textarea, am as DialogFooter, B as Button, V as useBranch, d as useAuth, b3 as useSearchParams, Z as TooltipProvider, P as Package, a1 as DollarSign, aC as cn, G as Truck, a5 as Tooltip, a6 as TooltipTrigger, s as RefreshCw, a7 as TooltipContent, ak as Plus, I as Input, X, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, L as Label, ae as FileText, b1 as formatDateTime, b as Eye, O as Banknote, C as ChevronRight, ac as DialogDescription, ag as Separator, Q as ScrollArea, ah as CreditCard, af as Clock, ad as Badge } from "./index-B52pgjeh.js";
...
import { F as Filter } from "./filter-DI7ijKhR.js";
...
function ReverseDialog({ purchase, open, onClose, onConfirmed }) {
  const [preflight, setPreflight] = reactExports.useState(null);
  const [reason, setReason] = reactExports.useState("");
  const [submitting, setSubmitting] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const runPreflight = reactExports.useCallback(async (purchaseId) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (next) => !next && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "h-4 w-4" }),
      " Reverse Purchase Order"
    ] }) }),
    purchase && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded border p-3 text-sm bg-muted/30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono font-medium", children: purchase.purchaseOrderNumber }),
      ...
      preflight === null ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Checking reversibility…" }) : preflight.allowed ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 rounded bg-green-500/10 p-2 text-xs text-green-700 dark:text-green-400", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 mt-0.5" }),
        "Ready to reverse. Stock, cost layers, and linked payable/expense will be cascaded."
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 rounded bg-destructive/10 p-2 text-xs text-destructive", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 font-medium", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3 w-3" }),
          " Cannot reverse:"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "ml-5 list-disc", children: preflight.blockers.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: b }, b)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "reverse-reason", className: "text-xs font-medium", children: "Reason (required, min 10 characters)" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 rounded border border-amber-500/30 bg-amber-500/5 p-2 text-[11px] text-amber-700 dark:text-amber-400", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3 w-3 mt-0.5" }),
        "This reverses stock quantities, cost layers, and any linked payable / expense. The reversal and reason are permanent."
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "destructive", onClick: handleConfirm, disabled: !canConfirm, children: submitting ? "Reversing…" : "Reverse and open re-entry form" })
    ] })
  ] }) });
}
...
function PurchasesScreen() {
  ...
  const [payMode, setPayMode] = reactExports.useState("full");
  const [partialAmount, setPartialAmount] = reactExports.useState("");
  ...
  const [syncDriftPurchase, setSyncDriftPurchase] = reactExports.useState(null);
  const [isSyncing, setIsSyncing] = reactExports.useState(false);
  const [reversingPurchase, setReversingPurchase] = reactExports.useState(null);
  const [isReentry, setIsReentry] = reactExports.useState(false);
  const [reentrySourcePO, setReentrySourcePO] = reactExports.useState("");
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case "reversed":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: "Reversed" });
      default:
  ...
  const handleViewPurchase = async (purchase) => {
    try {
      ...
      let paymentHistory = [];
      let linkedPayableStatus = null;
      let linkedPayableRemaining = null;
      try {
        const payablesRes = await window.api.payables.getAll({ limit: 1e3 });
      ...
      if (linkedPayableStatus === "paid" && (linkedPayableRemaining ?? 0) <= 0 && purchase.paymentStatus !== "paid") {
  ...
  const handleOpenReverseDialog = (purchase) => {
    setReversingPurchase(purchase);
  };
  const handleReversalConfirmed = (prefillDraft) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    paginatedPurchases.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-40 items-center justify-center rounded-lg border border-dashed text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30 hover:bg-muted/30", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[90px] text-right text-[10px] font-semibold uppercase tracking-wider text-muted-foreground", children: "Paid" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[90px] text-right text-[10px] font-semibold uppercase tracking-wider text-muted-foreground", children: "Remaining" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: paginatedPurchases.map((purchase) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "group h-9", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1.5 text-right text-sm tabular-nums text-green-600", children: formatCurrency(purchase.paidAmount ?? 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TableCell,
          {
            className: `py-1.5 text-right text-sm tabular-nums font-medium ${(purchase.remainingAmount ?? 0) > 0 ? "text-red-600" : "text-muted-foreground"}`,
            children: formatCurrency(purchase.remainingAmount ?? 0)
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1.5 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-0.5", children: [
          ...
          purchase.status !== "received" && purchase.status !== "cancelled" && purchase.status !== "reversed" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
          ...
          purchase.paymentStatus === "pending" && purchase.status !== "cancelled" && purchase.status !== "reversed" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
          ...
          isAdmin && purchase.status !== "cancelled" && purchase.status !== "reversed" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "h-3.5 w-3.5 text-destructive" })
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: "Reverse & Re-enter" })
          ] })
        ] }) })
      ] }, purchase.id)) })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isCreateDialogOpen, onOpenChange: setIsCreateDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-3xl max-h-[90vh] overflow-y-auto", children: [
      ...
      isReentry && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 rounded border border-amber-500/30 bg-amber-500/5 p-2 text-xs text-amber-700 dark:text-amber-400", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "h-3.5 w-3.5 mt-0.5 shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          "Re-entry of reversed",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-medium", children: reentrySourcePO }),
          ". Edit any fields before saving — a fresh purchase order will be created."
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isViewDialogOpen, onOpenChange: setIsViewDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl max-h-[90vh] overflow-y-auto", children: [
      ...
      viewingPurchase && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        viewingPurchase?.paymentHistory && viewingPurchase.paymentHistory.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 rounded-md border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground", children: "Payment History" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: viewingPurchase.paymentHistory.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: formatDateTime(p.paymentDate) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right text-xs tabular-nums", children: formatCurrency(p.amount) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs capitalize", children: p.paymentMethod.replace("_", " ") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: p.referenceNumber ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: p.notes ?? "—" })
            ] }, p.id)) })
          ] })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isPayOffDialogOpen, onOpenChange: setIsPayOffDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
      ...
      payingOffPurchase && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          payMode === "partial" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "partial-amount", className: "text-xs", children: [
              "Amount (max ",
              formatCurrency(payingOffPurchase?.remainingAmount ?? payingOffPurchase?.totalAmount ?? 0),
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "This will mark the purchase as paid and update the associated payable record." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Sync purchase status?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { children: [
              "The linked payable is already fully settled, but this purchase still shows",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: syncDriftPurchase?.paymentStatus }),
              "."
            ] })
          ] }),
          syncDriftPurchase && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded border p-3 bg-muted/30 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono font-medium", children: syncDriftPurchase.purchaseOrderNumber }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground text-xs mt-1", children: [
                "Total ",
                formatCurrency(syncDriftPurchase.totalAmount),
                " · Current status:",
                " ",
                syncDriftPurchase.paymentStatus
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "This only updates the purchase's payment status to match the payable. No new payment is recorded and no money movement is posted. Audit-logged." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleConfirmSyncDrift, disabled: isSyncing, children: isSyncing ? "Syncing..." : "Sync status" })
          ] })
        ] })
      }
    ),
