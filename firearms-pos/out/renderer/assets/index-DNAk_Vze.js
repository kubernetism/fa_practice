import { c as createLucideIcon, V as useBranch, Y as useCurrency, d as useAuth, r as reactExports, j as jsxRuntimeExports, Z as TooltipProvider, a5 as Tooltip, a6 as TooltipTrigger, B as Button, W as Wrench, a7 as TooltipContent, s as RefreshCw, ak as Plus, a3 as Card, a4 as CardContent, b2 as Landmark, aC as cn, af as Clock, _ as Tabs, $ as TabsList, ah as CreditCard, G as Truck, ae as FileText, a0 as TabsTrigger, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, I as Input, w as Check, ad as Badge, X, C as ChevronRight, a8 as Dialog, a9 as DialogContent, aa as DialogHeader, ab as DialogTitle, ac as DialogDescription, L as Label, q as Textarea, am as DialogFooter } from "./index-B52pgjeh.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { delayDuration: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        user?.role === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              onClick: async () => {
                ...
                if (!ok) return;
                try {
                  const res = await window.api.onlineTransactions.backfillClearing();
                  if (res?.success) {
                    window.alert(
                      `Backfill complete.
...
Skipped (already done): ${res.data.totalPending - res.data.backfilled}`
                  ...
                  window.alert(`Backfill error: ${e.message}`);
                }
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "h-3.5 w-3.5 mr-1.5" }),
                "Backfill"
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: "Migrate legacy pending GL postings into the 1030 clearing model. Admin-only, idempotent." })
        ] }),
