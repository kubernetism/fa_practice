...
const POSScreen = lazy(() =>
  import("@/screens/pos").then((m) => ({ default: m.POSScreen })),
);
const ProductsScreen = lazy(() =>
  import("@/screens/products").then((m) => ({ default: m.ProductsScreen })),
);
const InventoryScreen = lazy(() =>
  import("@/screens/inventory").then((m) => ({ default: m.InventoryScreen })),
);
const SalesHistoryScreen = lazy(() =>
  import("@/screens/sales").then((m) => ({ default: m.SalesHistoryScreen })),
);
const PurchasesScreen = lazy(() =>
  import("@/screens/purchases").then((m) => ({ default: m.PurchasesScreen })),
);
const ReturnsScreen = lazy(() =>
  import("@/screens/returns").then((m) => ({ default: m.ReturnsScreen })),
);
...
const AccountPayablesScreen = lazy(() =>
  import("@/screens/account-payables").then((m) => ({
    default: m.AccountPayablesScreen,
  })),
);
const AccountReceivablesScreen = lazy(() =>
  import("@/screens/account-receivables").then((m) => ({
    default: m.AccountReceivablesScreen,
  })),
);
...
const BusinessSettingsScreen = lazy(() =>
  import("@/screens/business-settings").then((m) => ({
    default: m.BusinessSettingsScreen,
  })),
);
const AuditLogsScreen = lazy(() =>
  import("@/screens/audit-logs").then((m) => ({ default: m.AuditLogsScreen })),
);
const DatabaseViewerScreen = lazy(() =>
  import("@/screens/database-viewer").then((m) => ({
    default: m.DatabaseViewerScreen,
  })),
);
const LicenseSettingsScreen = lazy(() =>
  import("@/screens/license-settings").then((m) => ({
    default: m.LicenseSettingsScreen,
  })),
);
...
const TaxCollectionsScreen = lazy(() =>
  import("@/screens/tax-collections").then((m) => ({
    default: m.TaxCollectionsScreen,
  })),
);
const CategoriesManagementScreen = lazy(() =>
  import("@/screens/categories-management").then((m) => ({
    default: m.CategoriesManagementScreen,
  })),
);
const DiscountManagementScreen = lazy(() =>
  import("@/screens/discount-management").then((m) => ({
...
const ServicesScreen = lazy(() =>
  import("@/screens/services").then((m) => ({
